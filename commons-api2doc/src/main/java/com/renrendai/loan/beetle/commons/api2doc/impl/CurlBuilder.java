...
import com.renrendai.loan.beetle.commons.api2doc.domain.ApiParamLocation;
import com.renrendai.loan.beetle.commons.api2doc.domain.ApiParamObject;
import com.renrendai.loan.beetle.commons.api2doc.domain.ApiDocObject;
import com.renrendai.loan.beetle.commons.api2doc.domain.ApiParamLocation;
import com.renrendai.loan.beetle.commons.api2doc.domain.ApiParamObject;
import com.renrendai.loan.beetle.commons.util.Encoding;
import com.renrendai.loan.beetle.commons.util.Strings;
import com.renrendai.loan.beetle.commons.util.value.KeyedList;
import com.renrendai.loan.beetle.commons.util.value.ValueSource;
...
public class CurlBuilder {
    ...
    public static String toCurl(ApiDocObject docObject, String serverURL) {
        ...
        if (params.size() > 0) {
            if (parts.size() > 0) {
                ...
                // 参数按 post 的方法传。
                sb.append(" -d \"").append(jsonType? joinJson(params) : joinText(params, "&", "="))
                        .append("\"").append(enter);
            } else {
                // 参数附加到 URL 后面。
                url += ("?" + joinText(params, "&", "="));
    ...
    public static final String joinJson(KeyedList<String, String> params){
